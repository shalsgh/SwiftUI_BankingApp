...
var sampleCard: [Card] = [
    ...
    .init(cardName: "iJustine", cardColor: Color("Card 1"), cardBalance: "$1024.9", exepnses: [
    ...
    .init(cardName: "iJustine", cardColor: Color("Card 2"), cardBalance: "$2439.5", exepnses: [
    ...
    .init(cardName: "iJustine", cardColor: Color("Card 3"), cardBalance: "$459.78", exepnses: [
